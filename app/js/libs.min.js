! function (t) {
  ...
  s = 0, (a = function (t, e) {
    ...
    if ("window" === n.respondTo ? s = l : "slider" === n.respondTo ? s = r : "min" === n.respondTo && (s = Math.min(l, r)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
      ...
      null !== o ? null !== n.activeBreakpoint && o === n.activeBreakpoint && !e || (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = c.extend({}, n.originalSettings, n.breakpointSettings[o]), !0 === t && (n.currentSlide = n.options.initialSlide), n.refresh(t)), a = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === t && (n.currentSlide = n.options.initialSlide), n.refresh(t), a = o), t || !1 === a || n.$slider.trigger("breakpoint", [n, a])
    }
    ...
    var e, i, o, s, n = this,
      a = 0;
    return n.slideOffset = 0, i = n.$slides.first().outerHeight(!0), !0 === n.options.infinite ? (n.slideCount > n.options.slidesToShow && (n.slideOffset = n.slideWidth * n.options.slidesToShow * -1, s = -1, !0 === n.options.vertical && !0 === n.options.centerMode && (2 === n.options.slidesToShow ? s = -1.5 : 1 === n.options.slidesToShow && (s = -2)), a = i * n.options.slidesToShow * s), n.slideCount % n.options.slidesToScroll != 0 && t + n.options.slidesToScroll > n.slideCount && n.slideCount > n.options.slidesToShow && (a = t > n.slideCount ? (n.slideOffset = (n.options.slidesToShow - (t - n.slideCount)) * n.slideWidth * -1, (n.options.slidesToShow - (t - n.slideCount)) * i * -1) : (n.slideOffset = n.slideCount % n.options.slidesToScroll * n.slideWidth * -1, n.slideCount % n.options.slidesToScroll * i * -1))) : t + n.options.slidesToShow > n.slideCount && (n.slideOffset = (t + n.options.slidesToShow - n.slideCount) * n.slideWidth, a = (t + n.options.slidesToShow - n.slideCount) * i), n.slideCount <= n.options.slidesToShow && (a = n.slideOffset = 0), !0 === n.options.centerMode && n.slideCount <= n.options.slidesToShow ? n.slideOffset = n.slideWidth * Math.floor(n.options.slidesToShow) / 2 - n.slideWidth * n.slideCount / 2 : !0 === n.options.centerMode && !0 === n.options.infinite ? n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2) - n.slideWidth : !0 === n.options.centerMode && (n.slideOffset = 0, n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2)), e = !1 === n.options.vertical ? t * n.slideWidth * -1 + n.slideOffset : t * i * -1 + a, !0 === n.options.variableWidth && (o = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(t) : n.$slideTrack.children(".slick-slide").eq(t + n.options.slidesToShow), e = !0 === n.options.rtl ? o[0] ? -1 * (n.$slideTrack.width() - o[0].offsetLeft - o.width()) : 0 : o[0] ? -1 * o[0].offsetLeft : 0, !0 === n.options.centerMode && (o = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(t) : n.$slideTrack.children(".slick-slide").eq(t + n.options.slidesToShow + 1), e = !0 === n.options.rtl ? o[0] ? -1 * (n.$slideTrack.width() - o[0].offsetLeft - o.width()) : 0 : o[0] ? -1 * o[0].offsetLeft : 0, e += (n.$list.width() - o.outerWidth()) / 2)), e
    ...
    if (!0 === n.options.centerMode ? i = !0 === n.options.infinite ? (e = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (e = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, i = Math.ceil(e + n.options.slidesToShow), !0 === n.options.fade && (0 < e && e--, i <= n.slideCount && i++)), t = n.$slider.find(".slick-slide").slice(e, i), "anticipated" === n.options.lazyLoad)
      for (var s = e - 1, a = i, r = n.$slider.find(".slick-slide"), l = 0; l < n.options.slidesToScroll; l++) s < 0 && (s = n.slideCount - 1), t = (t = t.add(r.eq(s))).add(r.eq(a)), s--, a++;
    ...
    r.length ? (e = r.first(), i = e.attr("data-lazy"), o = e.attr("data-srcset"), s = e.attr("data-sizes") || a.$slider.attr("data-sizes"), (n = document.createElement("img")).onload = function () {
      o && (e.attr("srcset", o), s && e.attr("sizes", s)), e.attr("src", i).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === a.options.adaptiveHeight && a.setPosition(), a.$slider.trigger("lazyLoaded", [a, e, i]), a.progressiveLazyLoad()
    }, n.onerror = function () {
    ...
    n.$slides.eq(t).addClass("slick-current"), !0 === n.options.centerMode ? (o = n.options.slidesToShow % 2 == 0 ? 1 : 0, s = Math.floor(n.options.slidesToShow / 2), !0 === n.options.infinite && (s <= t && t <= n.slideCount - 1 - s ? n.$slides.slice(t - s + o, t + s + 1).addClass("slick-active").attr("aria-hidden", "false") : (e = n.options.slidesToShow + t, a.slice(e - s + 1 + o, e + s + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === t ? a.eq(a.length - 1 - n.options.slidesToShow).addClass("slick-center") : t === n.slideCount - 1 && a.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(t).addClass("slick-center")) : 0 <= t && t <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(t, t + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : a.length <= n.options.slidesToShow ? a.addClass("slick-active").attr("aria-hidden", "false") : (i = n.slideCount % n.options.slidesToShow, e = !0 === n.options.infinite ? n.options.slidesToShow + t : t, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - t < n.options.slidesToShow ? a.slice(e - (n.options.slidesToShow - i), e + i).addClass("slick-active").attr("aria-hidden", "false") : a.slice(e, e + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" !== n.options.lazyLoad && "anticipated" !== n.options.lazyLoad || n.lazyLoad()
    ...
    return s < 0 && (s = 360 - Math.abs(s)), s <= 45 && 0 <= s || s <= 360 && 315 <= s ? !1 === t.options.rtl ? "left" : "right" : 135 <= s && s <= 225 ? !1 === t.options.rtl ? "right" : "left" : !0 === t.options.verticalSwiping ? 35 <= s && s <= 135 ? "down" : "up" : "vertical"
    ...
    for (var t, e = this, i = arguments[0], o = Array.prototype.slice.call(arguments, 1), s = e.length, n = 0; n < s; n++)
      if ("object" == typeof i || void 0 === i ? e[n].slick = new a(e[n], i) : t = e[n].slick[i].apply(e[n].slick, o), void 0 !== t) return t;
    return e
  }
}),
function (t) {
  ...
  function p(t, e, i, o) {
    ...
    return s.className = "mfp-" + t, i && (s.innerHTML = i), o ? e && e.appendChild(s) : (s = d(s), e && s.appendTo(e)), s
  }
  ...
  t.prototype = {
    ...
    open: function (t) {
      ...
      if (!m.isOpen) {
        ...
        u("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (h(y, function (t, e, i, o) {
        ...
        return m.isIE7 && (c += " mfp-ie7"), c && m._addClassToMFP(c), m.updateItemHTML(), u("BuildControls"), d("html").css(l), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || d(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function () {
          m.content ? (m._addClassToMFP(w), m._setFocus()) : m.bgOverlay.addClass(w), g.on("focusin" + _, m._onFocusIn)
        }, 16), m.isOpen = !0, m.updateSize(r), u(b), t
      }
      m.updateItemHTML()
    },
    close: function () {
    ...
    _close: function () {
      ...
      m.bgOverlay.detach(), m.wrap.detach(), m.container.empty(), m.st.mainClass && (e += m.st.mainClass + " "), m._removeClassFromMFP(e), m.fixedContentPos && (t = {
        marginRight: ""
      }, m.isIE7 ? d("body, html").css("overflow", "") : t.overflow = "", d("html").css(t)), g.off("keyup.mfp focusin" + _), m.ev.off(_), m.wrap.attr("class", "mfp-wrap").removeAttr("style"), m.bgOverlay.attr("class", "mfp-bg"), m.container.attr("class", "mfp-container"), !m.st.showCloseBtn || m.st.closeBtnInside && !0 !== m.currTemplate[m.currItem.type] || m.currTemplate.closeBtn && m.currTemplate.closeBtn.detach(), m.st.autoFocusLast && m._lastFocusedEl && d(m._lastFocusedEl).focus(), m.currItem = null, m.content = null, m.currTemplate = null, m.prevHeight = 0, u("AfterClose")
    },
    updateSize: function (t) {
      var e, i;
      m.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, i = window.innerHeight * e, m.wrap.css("height", i), m.wH = i) : m.wH = t || x.height(), m.fixedContentPos || m.wrap.css("height", m.wH), u("Resize")
    },
    updateItemHTML: function () {
      var t = m.items[m.index];
      m.contentContainer.detach(), m.content && m.content.detach(), t.parsed || (t = m.parseEl(m.index));
      var e, i = t.type;
      u("BeforeChange", [m.currItem ? m.currItem.type : "", i]), m.currItem = t, m.currTemplate[i] || (e = !!m.st[i] && m.st[i].markup, u("FirstMarkupParse", e), m.currTemplate[i] = !e || d(e)), s && s !== t.type && m.container.removeClass("mfp-" + s + "-holder");
      var o = m["get" + i.charAt(0).toUpperCase() + i.slice(1)](t, m.currTemplate[i]);
      m.appendContent(o, i), t.preloaded = !0, u("Change", t), s = t.type, m.container.prepend(m.contentContainer), u("AfterChange")
    },
    appendContent: function (t, e) {
      (m.content = t) ? m.st.showCloseBtn && m.st.closeBtnInside && !0 === m.currTemplate[e] ? m.content.find(".mfp-close").length || m.content.append(f()) : m.content = t: m.content = "", u("BeforeAppend"), m.container.addClass("mfp-" + e + "-holder"), m.contentContainer.append(m.content)
    },
    parseEl: function (t) {
      var e, i = m.items[t];
      if ((i = i.tagName ? {
    ...
    updateStatus: function (t, e) {
      var i;
      m.preloader && (o !== t && m.container.removeClass("mfp-s-" + o), e || "loading" !== t || (e = m.st.tLoading), u("UpdateStatus", i = {
        status: t,
        text: e
    ...
    _onFocusIn: function (t) {
      if (t.target !== m.wrap[0] && !d.contains(m.wrap[0], t.target)) return m._setFocus(), !1
    },
    _parseMarkup: function (s, t, e) {
      var n;
      e.data && (t = d.extend(e.data, t)), u(y, [s, t, e]), d.each(t, function (t, e) {
        return void 0 === e || !1 === e || void(1 < (n = t.split("_")).length ? 0 < (i = s.find(_ + "-" + n[0])).length && ("replaceWith" === (o = n[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === o ? i.is("img") ? i.attr("src", e) : i.replaceWith(d("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(n[1], e)) : s.find(_ + "-" + t).html(e));
        var i, o
      })
    },
    ...
    n();
    var e, i, o, s = d(this);
    return "string" == typeof t ? "open" === t ? (e = r ? s.data("magnificPopup") : s[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, o = e.items ? e.items[i] : (o = s, e.delegate && (o = o.find(e.delegate)), o.eq(i)), m._openClick({
      mfpEl: o
    }, s, e)) : m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1)) : (t = d.extend(!0, {}, t), r ? s.data("magnificPopup", t) : s[0].magnificPopup = t, m.addGroup(s, t)), s
  };
    ...
    proto: {
      ...
      getInline: function (t, e) {
        if (C(), t.src) {
          var i, o = m.st.inline,
            s = d(t.src);
          return s.length ? ((i = s[0].parentNode) && i.tagName && (k || (S = o.hiddenClass, k = p(S), S = "mfp-" + S), T = s.after(k).detach().removeClass(S)), m.updateStatus("ready")) : (m.updateStatus("error", o.tNotFound), s = d("<div>")), t.inlineElement = s
        }
  ...
  d.magnificPopup.registerModule(E, {
    ...
    proto: {
      initAjax: function () {
        m.types.push(E), $ = m.st.ajax.cursor, h(l + "." + E, I), h("BeforeChange." + E, I)
      },
      getAjax: function (s) {
        $ && d(document.body).addClass($), m.updateStatus("loading");
        var t = d.extend({
          url: s.src,
          success: function (t, e, i) {
            ...
            u("ParseAjax", o), m.appendContent(d(o.data), E), s.finished = !0, O(), m._setFocus(), setTimeout(function () {
              m.wrap.addClass(w)
            }, 16), m.updateStatus("ready"), u("AjaxContentAdded")
          },
          error: function () {
            O(), s.finished = s.loadError = !0, m.updateStatus("error", m.st.ajax.tError.replace("%url%", s.src))
          }
        }, m.st.ajax.settings);
  ...
  d.magnificPopup.registerModule("image", {
    ...
    proto: {
      initImage: function () {
        var t = m.st.image,
          e = ".image";
        m.types.push("image"), h(b + e, function () {
          "image" === m.currItem.type && t.cursor && d(document.body).addClass(t.cursor)
        }), h(l + e, function () {
          t.cursor && d(document.body).removeClass(t.cursor), x.off("resize" + _)
      ...
      _onImageHasSize: function (t) {
        t.img && (t.hasSize = !0, D && clearInterval(D), t.isCheckingImgSize = !1, u("ImageHasSize", t), t.imgHidden && (m.content && m.content.removeClass("mfp-loading"), t.imgHidden = !1))
      },
        ...
        var i = 0,
          ...
          s = function (t) {
            D && clearInterval(D), D = setInterval(function () {
              0 < o.naturalWidth ? m._onImageHasSize(e) : (200 < i && clearInterval(D), 3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500))
            }, t)
          };
        s(1)
      },
      getImage: function (t, e) {
        var i, o = 0,
          s = function () {
            t && (t.img[0].complete ? (t.img.off(".mfploader"), t === m.currItem && (m._onImageHasSize(t), m.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, u("ImageLoadComplete")) : ++o < 200 ? setTimeout(s, 100) : n())
          },
          n = function () {
          ...
          a = m.st.image,
          r = e.find(".mfp-img");
        return r.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = d(i).on("load.mfploader", s).on("error.mfploader", n), i.src = t.src, r.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), m._parseMarkup(e, {
          title: function (t) {
        ...
        }, t), m.resizeImage(), t.hasSize ? (D && clearInterval(D), t.loadError ? (e.addClass("mfp-loading"), m.updateStatus("error", a.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), m.findImageSize(t))), e
      }
    }
  });
  var P;
  d.magnificPopup.registerModule("zoom", {
    ...
    proto: {
      initZoom: function () {
        var t, e, i, o, s, n, a = m.st.zoom,
          r = ".zoom";
        a.enabled && m.supportsTransition && (e = a.duration, i = function (t) {
          ...
          if (m._allowZoom()) {
            ...
            (n = i(t)).css(m._getOffset()), m.wrap.append(n), s = setTimeout(function () {
          ...
          if (m._allowZoom()) {
            if (clearTimeout(s), m.st.removalDelay = e, !t) {
          ...
          m._allowZoom() && (o(), n && n.remove(), t = null)
        }))
      },
      _allowZoom: function () {
      ...
      _getOffset: function (t) {
        ...
        return void 0 === P && (P = void 0 !== document.createElement("p").style.MozTransform), P ? n["-moz-transform"] = n.transform = "translate(" + i.left + "px," + i.top + "px)" : (n.left = i.left, n.top = i.top), n
      }
    }
  });
  ...
  function F(t) {
    var e;
    !m.currTemplate[M] || (e = m.currTemplate[M].find("iframe")).length && (t || (e[0].src = "//about:blank"), m.isIE8 && e.css("display", t ? "block" : "none"))
  }
  var M = "iframe";
  d.magnificPopup.registerModule(M, {
    ...
    proto: {
      initIframe: function () {
        m.types.push(M), h("BeforeChange", function (t, e, i) {
          e !== i && (e === M ? F() : i === M && F(!0))
        }), h(l + "." + M, function () {
          F()
        })
      ...
      getIframe: function (t, e) {
        ...
        var s = {};
        return o.srcAction && (s[o.srcAction] = i), m._parseMarkup(e, s, t), m.updateStatus("ready"), e
      }
    }
  });
  ...
  d.magnificPopup.registerModule("gallery", {
    ...
    proto: {
      initGallery: function () {
        ...
        }), h(y + t, function (t, e, i, o) {
          var s = m.items.length;
          i.counter = 1 < s ? R(n.tCounter, o.index, s) : ""
        }), h("BuildControls" + t, function () {
          var t, e, i;
          1 < m.items.length && n.arrows && !m.arrowLeft && (t = n.arrowMarkup, e = m.arrowLeft = d(t.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(a), i = m.arrowRight = d(t.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(a), e.click(function () {
            m.prev()
          }), i.click(function () {
            m.next()
      ...
      _preloadItem: function (t) {
        var e;
        t = N(t), m.items[t].preloaded || ((e = m.items[t]).parsed || (e = m.parseEl(t)), u("LazyLoad", e), "image" === e.type && (e.img = d('<img class="mfp-img" />').on("load.mfploader", function () {
          e.hasSize = !0
  ...
  d.magnificPopup.registerModule(B, {
    ...
    proto: {
      initRetina: function () {
        var i, o;
        1 < window.devicePixelRatio && (i = m.st.retina, o = i.ratio, 1 < (o = isNaN(o) ? o() : o) && (h("ImageHasSize." + B, function (t, e) {
          e.img.css({
...
function (p) {
  ...
  var u = null,
    f = null;
  ! function () {
    for (var t, s, n, a, r, e = ["webkit", "moz", "o", "ms"], i = p.document.createElement("div"), o = -1, o = 0; o < e.length && !p.requestAnimationFrame; o++) p.requestAnimationFrame = p[e[o] + "RequestAnimationFrame"];
    ...
    void 0 === i.nextElementSibling && Object.defineProperty(p.Element.prototype, "nextElementSibling", {
    ...
    }, Object.keys || (Object.keys = (s = Object.prototype.hasOwnProperty, n = [], a = !{
      toString: null
      ...
      if (a)
        for (o = 0; o < r; o++) s.call(t, n[o]) && e.push(n[o]);
      return e
      ...
      for (i = 0 <= e ? e : Math.max(s - Math.abs(e), 0); i < s; i++)
        if (i in o && o[i] === t) return i;
      return -1
    }), Function.prototype.bind || (Function.prototype.bind = function (t) {
      var e, i, o, s;
      if ("function" != typeof this) throw new TypeError;
      return e = Array.prototype.slice.call(arguments, 1), o = function () {}, s = function () {
        return i.apply(this instanceof o ? this : t, e.concat(Array.prototype.slice.call(arguments)))
      }, (i = this).prototype && (o.prototype = this.prototype), s.prototype = new o, s
    ...
    var o, s = null,
      ...
      h = -1,
      r = i || p.document;
    if ((n = arguments[3]) && (n = "boolean" == typeof n), "string" == typeof t) d = r.querySelectorAll(t);
    ...
    extend: function (e, t, i, o) {
      ...
      try {
        ...
        for (a = 0; a < n.length; a++) s = n[a], !i || "object" != typeof t[s] || this.isElement(t[s]) ? e[s] = t[s] : (Array.isArray(t[s]) ? e[s] || (e[s] = []) : e[s] || (e[s] = {}), this.extend(e[s], t[s], i, o))
      } catch (t) {
        if (!o) throw t;
    ...
    handleExtendError: function (t, e) {
      var i, o = null,
        ...
        l = -1,
        c = -1;
      if (t instanceof TypeError && (o = /property "?(\w*)"?[,:] object/i.exec(t.message))) {
        for (r in s = o[1], e) {
          for (c = 0; c < s.length && s.charAt(c) === r.charAt(c);) c++;
          l < c && (l = c, a = r)
        }
    ...
    template: function (o) {
      for (var t, e = /\${([\w]*)}/g, s = {}; t = e.exec(o);) s[t[1]] = new RegExp("\\${" + t[1] + "}", "g");
      return function (t) {
        var e = "",
          i = o;
    ...
    getCustomEvent: function (t, e, i) {
      var o = null;
      return i = i || p.document, "function" == typeof p.CustomEvent ? o = new p.CustomEvent(t, {
        detail: e,
        bubbles: !0,
        cancelable: !0
      }) : "function" == typeof i.createEvent ? (o = i.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e) : ((o = i.createEventObject()).type = t, o.returnValue = !1, o.cancelBubble = !1, o.detail = e), o
    },
    ...
    createElement: function (t, e) {
      ...
      for ((o = e.createElement("div")).innerHTML = t.trim(); o.firstChild;) i.appendChild(o.firstChild);
      return i
    },
    ...
    arrayShuffle: function (t) {
      for (var e, i, o = t.slice(), s = o.length, n = s; n--;) e = ~~(Math.random() * s), i = o[n], o[n] = o[e], o[e] = i;
      return o
    },
    ...
    debounce: function (s, n, a) {
      ...
      return function () {
        var t = this,
          ...
          i = a && !r,
          o = function () {
            r = null, a || s.apply(t, e)
          };
        clearTimeout(r), r = setTimeout(o, n), i && s.apply(t, e)
      }
    },
    position: function (t) {
      for (var e = 0, i = 0, o = t; t;) e -= t.scrollLeft, i -= t.scrollTop, t === o && (e += t.offsetLeft, i += t.offsetTop, o = t.offsetParent), t = t.parentElement;
      return {
        x: e,
        y: i
      }
    ...
    getIntersectionRatio: function (t, e) {
      var i = t.width * t.height,
        o = Math.max(0, Math.min(t.left + t.width, e.left + e.width) - Math.max(t.left, e.left));
      return Math.max(0, Math.min(t.top + t.height, e.top + e.height) - Math.max(t.top, e.top)) * o / i
    },
    ...
    children: function (t, e, i) {
      var o = [],
        s = "";
      return i = i || p.doc, t && (t.id || (s = "Temp" + this.randomHexKey(), t.id = s), o = i.querySelectorAll("#" + t.id + " > " + e), s && t.removeAttribute("id")), o
    },
    clean: function (t) {
    ...
    defer: function (t) {
      ...
      }) : (o = p.jQuery || t.$) && "function" == typeof o.Deferred ? (e = o.Deferred(), i.promise = e.promise(), i.resolve = e.resolve, i.reject = e.reject) : p.console && console.warn(u.messages.warningNoPromiseImplementation()), i
    },
    all: function (t, e) {
      var i = null;
    ...
    compareVersions: function (t, e) {
      for (var i, o, s = t.split("."), n = e.split("."), a = -1, a = 0; a < s.length; a++) {
        if (i = parseInt(s[a].replace(/[^\d.]/g, "")), (o = parseInt(n[a].replace(/[^\d.]/g, "") || 0)) < i) return !1;
        if (i < o) return !0
      }
      return !0
    },
    ...
    getClassname: function (t, e, i) {
      var o = "";
      return (o += t.block).length && (o += t.delineatorElement), o += t["element" + this.pascalCase(e)], i ? (o.length && (o += t.delineatorModifier), o += i) : o
    },
    ...
    callFilters: function (t, e, i) {
      ...
      for (n in i = i || [], o)(i = f.arrayFromList(i)).unshift(s), s = o[n].apply(this, i);
      return s
    }
  ...
  }, u.BaseStatic.call(u.CommandChangeLayout), u.CommandChangeLayout.prototype = Object.create(u.Base.prototype), u.CommandChangeLayout.prototype.constructor = u.CommandChangeLayout, u.ControlDefinition = function (t, e, i, o) {
    u.Base.call(this), this.callActions("beforeConstruct"), this.type = t, this.selector = e, this.live = i || !1, this.parent = o || "", this.callActions("afterConstruct"), f.freeze(this), f.seal(this)
    ...
    init: function (t, e, i) {
      ...
      o.bindClick(), u.controls.push(o), this.callActions("afterInit", arguments)
    },
    isBound: function (t) {
      var e;
    ...
    handleClick: function (t) {
      var e, i = this,
        ...
        r = [],
        l = -1;
      if (this.callActions("beforeHandleClick", arguments), this.pending = 0, s = i.bound[0], o = i.selector ? f.closestParent(t.target, s.config.selectors.control + i.selector, !0, s.dom.document) : i.el) {
        switch (i.type) {
          case "filter":
          ...
          case "multimix":
            ...
            break;
          case "toggle":
            a.filter = i.filter || o.getAttribute("data-toggle"), n = "live" === i.status ? f.hasClass(o, i.classNames.active) : "active" === i.status
        }
        for (l = 0; l < i.bound.length; l++) e = new u.CommandMultimix, f.extend(e, a), r.push(e);
        for (r = i.callFilters("commandsHandleClick", r, arguments), i.pending = i.bound.length, l = 0; s = i.bound[l]; l++)(a = r[l]) && (s.lastClicked || (s.lastClicked = o), u.events.fire("mixClick", s.dom.container, {
          state: s.state,
          instance: s,
          originalEvent: t,
          control: s.lastClicked
        }, s.dom.document), "function" == typeof s.config.callbacks.onMixClick && !1 === s.config.callbacks.onMixClick.call(s.lastClicked, s.state, t, s) || ("toggle" === i.type ? n ? s.toggleOff(a.filter) : s.toggleOn(a.filter) : s.multimix(a)));
    ...
    update: function (t, e) {
      ...
      i.callActions("beforeUpdate", arguments), i.pending--, i.pending = Math.max(0, i.pending), 0 < i.pending || ("live" === i.status ? i.updateLive(t, e) : (o.sort = i.sort, o.filter = i.filter, i.callFilters("actionsUpdate", o, arguments), i.parseStatusChange(i.el, t, o, e)), i.callActions("afterUpdate", arguments))
    },
        ...
        for (i = o.el.querySelectorAll(o.selector), a = 0; n = i[a]; a++) {
          switch (s = new u.CommandMultimix, o.type) {
            ...
            case "sort":
              ...
              break;
            case "multimix":
              s.filter = n.getAttribute("data-filter"), s.sort = n.getAttribute("data-sort");
              break;
            case "toggle":
              s.filter = n.getAttribute("data-toggle")
          }
          s = o.callFilters("actionsUpdateLive", s, arguments), o.parseStatusChange(n, t, s, e)
        }
    ...
    parseStatusChange: function (t, e, i, o) {
      ...
      switch (s.callActions("beforeParseStatusChange", arguments), s.type) {
        ...
        case "multimix":
          ...
          break;
        case "sort":
          e.sort.match(/:asc/g) && (n = e.sort.replace(/:asc/g, "")), e.sort === i.sort || n === i.sort ? s.renderStatus(t, "active") : s.renderStatus(t, "inactive");
          break;
        case "toggle":
  ...
  }, u.BaseStatic.call(u.Events), u.Events.prototype = Object.create(u.Base.prototype), u.Events.prototype.constructor = u.Events, u.Events.prototype.fire = function (t, e, i, o) {
    var s, n = new u.EventDetail;
    if (this.callActions("beforeFire", arguments), void 0 === this[t]) throw new Error('Event type "' + t + '" not found.');
    n.state = new u.State, f.extend(n.state, i.state), i.futureState && (n.futureState = new u.State, f.extend(n.futureState, i.futureState)), n.instance = i.instance, i.originalEvent && (n.originalEvent = i.originalEvent), s = f.getCustomEvent(t, n, o), this.callFilters("eventFire", s, arguments), e.dispatchEvent(s)
    ...
    indexTargets: function () {
      ...
      if (i.dom.targets.length) {
        for (s = 0; t = i.dom.targets[s]; s++)(o = new u.Target).init(t, i, e ? e[s] : void 0), o.isInDom = !0, i.targets.push(o);
    ...
    initControls: function () {
      ...
      for (r = 0; t = u.controlDefinitions[r]; r++)
        if (i.config.controls.live || t.live) {
          ...
          for (l = 0; o = n[l]; l++) a = i.getControl(o, t.type, t.selector), i.controls.push(a)
        } else
          for (e = s.querySelectorAll(i.config.selectors.control + t.selector), l = 0; o = e[l]; l++)(a = i.getControl(o, t.type, "")) && i.controls.push(a);
    ...
    getControl: function (t, e, i) {
      ...
      if (o.callActions("beforeGetControl", arguments), !i)
        for (n = 0; s = u.controls[n]; n++) {
          if (s.el === t && s.isBound(o)) return o.callFilters("controlGetControl", null, arguments);
          if (s.el === t && s.type === e && s.selector === i) return s.addBinding(o), o.callFilters("controlGetControl", s, arguments)
        }
    ...
    buildToggleArray: function (t, e) {
      ...
      o !== i.config.selectors.target && "all" !== o || (o = ""), "or" === i.config.controls.toggleLogic ? i.toggleArray = o.split(",") : i.toggleArray = i.splitCompoundSelector(o), i.toggleArray = f.clean(i.toggleArray), i.callActions("afterBuildToggleArray", arguments)
    },
    splitCompoundSelector: function (t) {
      var e = t.split(/([\.\[])/g),
        ...
        o = "",
        s = -1;
      for ("" === e[0] && e.shift(), s = 0; s < e.length; s++) s % 2 == 0 && (o = ""), o += e[s], s % 2 != 0 && i.push(o);
      return i
    },
    ...
    insertTargets: function (t, e) {
      ...
      if (o.callActions("beforeInsertTargets", arguments), void 0 === t.index && (t.index = 0), i = o.getNextSibling(t.index, t.sibling, t.position), n = o.dom.document.createDocumentFragment(), s = i ? f.index(i, o.config.selectors.target) : o.targets.length, t.collection) {
        for (l = 0; r = t.collection[l]; l++) {
          ...
          r.style.display = "none", n.appendChild(r), n.appendChild(o.dom.document.createTextNode(" ")), f.isElement(r, o.dom.document) && r.matches(o.config.selectors.target) && ((a = new u.Target).init(r, o), a.isInDom = !0, o.targets.splice(s, 0, a), s++)
        }
        o.dom.parent.insertBefore(n, i)
      }
      e.startOrder = o.origOrder = o.targets, o.callActions("afterInsertTargets", arguments)
    },
    ...
    filterOperation: function (t) {
      var e, i, o = !1,
        s = null,
        n = -1;
      for (this.callActions("beforeFilterOperation", arguments), i = t.newFilter.action, n = 0; s = t.newOrder[n]; n++) o = t.newFilter.collection ? -1 < t.newFilter.collection.indexOf(s.dom.el) : "" !== t.newFilter.selector && s.dom.el.matches(t.newFilter.selector), this.evaluateHideShow(o, s, i, t);
      if (t.toRemove.length)
        for (n = 0; s = t.show[n]; n++) - 1 < t.toRemove.indexOf(s) && (t.show.splice(n, 1), -1 < (e = t.toShow.indexOf(s)) && t.toShow.splice(e, 1), t.toHide.push(s), t.hide.push(s), n--);
    ...
    evaluateHideShow: function (t, e, i, o) {
      var s = Array.prototype.slice.call(arguments, 1),
        n = this.callFilters("testResultEvaluateHideShow", t, s);
      this.callActions("beforeEvaluateHideShow", arguments), !0 === n && "show" === i || !1 === n && "hide" === i ? (o.show.push(e), e.isShown || o.toShow.push(e)) : (o.hide.push(e), e.isShown && o.toHide.push(e)), this.callActions("afterEvaluateHideShow", arguments)
    },
    sortOperation: function (i) {
      ...
      if (o.callActions("beforeSortOperation", arguments), i.startOrder = o.targets, i.newSort.collection) {
        for (e = [], n = 0; t = i.newSort.collection[n]; n++) {
          if (o.dom.targets.indexOf(t) < 0) throw new Error(u.messages.errorSortNonExistentElement());
          (s = new u.Target).init(t, o), s.isInDom = !0, e.push(s)
        }
        i.newOrder = e
      ...
      f.isEqualArray(i.newOrder, i.startOrder) && (i.willSort = !1), o.callActions("afterSortOperation", arguments)
    },
    compare: function (t, e, i) {
      var o = i.order,
        s = this.getAttributeValue(t, i.attribute),
        n = this.getAttributeValue(e, i.attribute),
        n = isNaN(+s) || isNaN(+n) ? (s = s.toLowerCase(), n.toLowerCase()) : (s = +s, +n);
      return s < n ? "asc" === o ? -1 : 1 : n < s ? "asc" === o ? 1 : -1 : s === n && i.next ? this.compare(t, e, i.next) : 0
    },
    ...
    printSort: function (t, e) {
      ...
      for ((i = a ? a.previousSibling : o.dom.parent.lastChild) && "#text" === i.nodeName && f.removeWhitespace(i), d = 0; l = n[d]; d++) c = l.dom.el, f.isElement(r.lastChild) && r.appendChild(p.document.createTextNode(" ")), r.appendChild(c);
      o.dom.parent.firstChild && o.dom.parent.firstChild !== a && r.insertBefore(p.document.createTextNode(" "), r.childNodes[0]), a ? (r.appendChild(p.document.createTextNode(" ")), o.dom.parent.insertBefore(r, a)) : o.dom.parent.appendChild(r), o.callActions("afterPrintSort", arguments)
    },
    parseSortString: function (t, e) {
      for (var i, o = t.split(" "), s = e, n = -1, n = 0; n < o.length; n++) {
        switch (i = o[n].split(":"), s.sortString = o[n], s.attribute = f.dashCase(i[0]), s.order = i[1] || "asc", s.attribute) {
          case "default":
            s.attribute = "";
            break;
          case "random":
        ...
        n < o.length - 1 && (s.next = new u.CommandSort, f.freeze(s), s = s.next)
      }
      ...
      if (e.indexOf(t) < 0) "stagger" === t && (l.staggerDuration = 0);
        ...
        switch (-1 < (n = e.indexOf(t + "(")) && (a = e.substring(n), c = /\(([^)]+)\)/.exec(a)[1]), t) {
          ...
          case "stagger":
            ...
            break;
          default:
            if (s && l.config.animation.reverseOut && "scale" !== t ? i[t].value = -1 * (c ? parseFloat(c) : u.transformDefaults[t].value) : i[t].value = c ? parseFloat(c) : u.transformDefaults[t].value, c) {
              for (h = 0; r = d[h]; h++)
                if (-1 < c.indexOf(r)) {
                  i[t].unit = r;
                  break
    ...
    getStartMixData: function (t) {
      ...
      for (e.incPadding = "border-box" === r, e.callActions("beforeGetStartMixData", arguments), a = 0; s = t.show[a]; a++) n = s.getPosData(), t.showPosData[a] = {
        startPosData: n
      };
      for (a = 0; s = t.toHide[a]; a++) n = s.getPosData(), t.toHidePosData[a] = {
        startPosData: n
      };
      t.startX = o.left, t.startY = o.top, t.startHeight = e.incPadding ? o.height : o.height - parseFloat(i.paddingTop) - parseFloat(i.paddingBottom) - parseFloat(i.borderTop) - parseFloat(i.borderBottom), t.startWidth = e.incPadding ? o.width : o.width - parseFloat(i.paddingLeft) - parseFloat(i.paddingRight) - parseFloat(i.borderLeft) - parseFloat(i.borderRight), e.callActions("afterGetStartMixData", arguments)
    },
    setInter: function (t) {
      var e = this,
        i = null,
    ...
    moveTargets: function (t) {
      ...
      for (e.callActions("beforeMoveTargets", arguments), l = 0; i = t.show[l]; l++) o = new u.IMoveData, s = t.showPosData[l], n = i.isShown ? "none" : "show", (a = e.willTransition(n, t.hasEffect, s.posIn, s.posOut)) && r++, i.show(), o.posIn = s.posIn, o.posOut = s.posOut, o.statusChange = n, o.staggerIndex = r, o.operation = t, o.callback = a ? c : null, i.move(o);
      for (l = 0; i = t.toHide[l]; l++) s = t.toHidePosData[l], o = new u.IMoveData, n = "hide", a = e.willTransition(n, s.posIn, s.posOut), o.posIn = s.posIn, o.posOut = s.posOut, o.statusChange = n, o.staggerIndex = l, o.operation = t, o.callback = a ? c : null, i.move(o);
    ...
    willTransition: function (t, e, i, o) {
      var s = !1,
        s = !!f.isVisible(this.dom.container) && (!!("none" !== t && e || i.x !== o.x || i.y !== o.y) || !!this.config.animation.animateResizeTargets && (i.width !== o.width || i.height !== o.height || i.marginRight !== o.marginRight || i.marginTop !== o.marginTop));
      return this.callFilters("resultWillTransition", s, arguments)
    },
    ...
    cleanUp: function (t) {
      var e, i, o = this,
        ...
        n = null,
        a = -1;
      for (o.callActions("beforeCleanUp", arguments), a = o.targetsMoved = o.targetsImmovable = o.targetsBound = o.targetsDone = 0; s = t.show[a]; a++) s.cleanUp(), s.show();
      for (a = 0; s = t.toHide[a]; a++) s.cleanUp(), s.hide();
      if (t.willSort && o.printSort(!1, t), o.dom.parent.style[u.features.transitionProp] = o.dom.parent.style.height = o.dom.parent.style.width = o.dom.parent.style.overflow = o.dom.parent.style[u.features.perspectiveProp] = o.dom.parent.style[u.features.perspectiveOriginProp] = "", t.willChangeLayout && (f.removeClass(o.dom.container, t.startContainerClassName), f.addClass(o.dom.container, t.newContainerClassName)), t.toRemove.length) {
        for (a = 0; s = o.targets[a]; a++) - 1 < t.toRemove.indexOf(s) && ((e = s.dom.el.previousSibling) && "#text" === e.nodeName && (n = s.dom.el.nextSibling) && "#text" === n.nodeName && f.removeWhitespace(e), t.willSort || o.dom.parent.removeChild(s.dom.el), o.targets.splice(a, 1), s.isInDom = !1, a--);
        o.origOrder = o.targets
      }
      t.willSort && (o.targets = t.newOrder), o.state = t.newState, o.lastOperation = t, o.dom.targets = o.state.targets, u.events.fire("mixEnd", o.dom.container, {
        state: o.state,
        instance: o
      }, o.dom.document), "function" == typeof o.config.callbacks.onMixEnd && o.config.callbacks.onMixEnd.call(o.dom.container, o.state, o), t.hasFailed && (u.events.fire("mixFail", o.dom.container, {
        state: o.state,
        instance: o
      }, o.dom.document), "function" == typeof o.config.callbacks.onMixFail && o.config.callbacks.onMixFail.call(o.dom.container, o.state, o), f.addClass(o.dom.container, f.getClassname(o.config.classNames, "container", o.config.classNames.modifierFailed))), "function" == typeof o.userCallback && o.userCallback.call(o.dom.container, o.state, o), "function" == typeof o.userDeferred.resolve && o.userDeferred.resolve(o.state), o.userCallback = null, o.userDeferred = null, o.lastClicked = null, o.isToggling = !1, o.isBusy = !1, o.queue.length && (o.callActions("beforeReadQueueCleanUp", arguments), i = o.queue.shift(), o.userDeferred = i.deferred, o.isToggling = i.isToggling, o.lastClicked = i.triggerElement, i.instruction.command instanceof u.CommandMultimix ? o.multimix.apply(o, i.args) : o.dataset.apply(o, i.args)), o.callActions("afterCleanUp", arguments)
    },
    parseMultimixArgs: function (t) {
      var e, i = this,
        o = new u.UserInstruction,
        s = -1;
      for (o.animate = i.config.animation.enable, o.command = new u.CommandMultimix, s = 0; s < t.length; s++) null !== (e = t[s]) && ("object" == typeof e ? f.extend(o.command, e) : "boolean" == typeof e ? o.animate = e : "function" == typeof e && (o.callback = e));
      return !o.command.insert || o.command.insert instanceof u.CommandInsert || (o.command.insert = i.parseInsertArgs([o.command.insert]).command), !o.command.remove || o.command.remove instanceof u.CommandRemove || (o.command.remove = i.parseRemoveArgs([o.command.remove]).command), !o.command.filter || o.command.filter instanceof u.CommandFilter || (o.command.filter = i.parseFilterArgs([o.command.filter]).command), !o.command.sort || o.command.sort instanceof u.CommandSort || (o.command.sort = i.parseSortArgs([o.command.sort]).command), !o.command.changeLayout || o.command.changeLayout instanceof u.CommandChangeLayout || (o.command.changeLayout = i.parseChangeLayoutArgs([o.command.changeLayout]).command), o = i.callFilters("instructionParseMultimixArgs", o, arguments), f.freeze(o), o
    },
    ...
    parseSortArgs: function (t) {
      var e, i = new u.UserInstruction,
        o = "",
        s = -1;
      for (i.animate = this.config.animation.enable, i.command = new u.CommandSort, s = 0; s < t.length; s++)
      ...
      return o && (i.command = this.parseSortString(o, i.command)), i = this.callFilters("instructionParseSortArgs", i, arguments), f.freeze(i), i
    },
    ...
    parseRemoveArgs: function (t) {
      var e, i, o = this,
        ...
        n = -1;
      for (s.animate = o.config.animation.enable, s.command = new u.CommandRemove, n = 0; n < t.length; n++)
        if (null !== (i = t[n])) switch (typeof i) {
          case "number":
            o.targets[i] && (s.command.targets[0] = o.targets[i]);
            break;
          case "string":
            s.command.collection = f.arrayFromList(o.dom.parent.querySelectorAll(i));
            break;
          case "object":
            i && i.length ? s.command.collection = i : f.isElement(i, o.dom.document) ? s.command.collection = [i] : f.extend(s.command, i);
            break;
          case "boolean":
            s.animate = i;
            break;
      ...
      if (s.command.collection.length)
        for (n = 0; e = o.targets[n]; n++) - 1 < s.command.collection.indexOf(e.dom.el) && s.command.targets.push(e);
      return !s.command.targets.length && o.config.debug.showWarnings && console.warn(u.messages.warningRemoveNoElements()), f.freeze(s), s
    },
    parseDatasetArgs: function (t) {
      var e, i = new u.UserInstruction,
        o = -1;
      for (i.animate = this.config.animation.enable, i.command = new u.CommandDataset, o = 0; o < t.length; o++)
    ...
    parseChangeLayoutArgs: function (t) {
      var e, i = new u.UserInstruction,
        o = -1;
      for (i.animate = this.config.animation.enable, i.command = new u.CommandChangeLayout, o = 0; o < t.length; o++)
        if (null !== (e = t[o])) switch (typeof e) {
          case "string":
    ...
    queueMix: function (t) {
      var e, i = this,
        o = null;
      return i.callActions("beforeQueueMix", arguments), o = f.defer(u.libraries), i.config.animation.queue && i.queue.length < i.config.animation.queueLimit ? (t.deferred = o, i.queue.push(t), i.config.controls.enable && (i.isToggling ? (i.buildToggleArray(t.instruction.command), e = i.getToggleSelector(), i.updateControls({
        filter: {
          selector: e
        }
      })) : i.updateControls(t.instruction.command))) : (i.config.debug.showWarnings && console.warn(u.messages.warningMultimixInstanceQueueFull()), o.resolve(i.state), u.events.fire("mixBusy", i.dom.container, {
        state: i.state,
        instance: i
    ...
    getDataOperation: function (t) {
      ...
      if (e.dom.targets.length && !(o = e.state.activeDataset || []).length) throw new Error(u.messages.errorDatasetNotSet());
      return i.id = f.randomHex(), i.startState = e.state, i.startDataset = o, i.newDataset = t.slice(), e.diffDatasets(i), i.startOrder = e.targets, i.newOrder = i.show, e.config.animation.enable && (e.getStartMixData(i), e.setInter(i), i.docState = f.getDocumentState(e.dom.document), e.getInterMixData(i), e.setFinal(i), e.getFinalMixData(i), e.parseEffects(), i.hasEffect = e.hasEffect(), e.getTweenData(i)), e.targets = i.show.slice(), i.newState = e.buildState(i), Array.prototype.push.apply(e.targets, i.toRemove), i = e.callFilters("operationMappedGetDataOperation", i, arguments)
    },
    diffDatasets: function (t) {
      ...
      for (e.callActions("beforeDiffDatasets", arguments), p = 0; n = t.newDataset[p]; p++) {
        ...
        d[h] = !0, (a = e.cache[h]) instanceof u.Target ? (e.config.data.dirtyCheck && !f.deepEquals(n, a.data) && (r = a.render(n), a.data = n, r !== a.dom.el && (a.isInDom && (a.unbindEvents(), e.dom.parent.replaceChild(r, a.dom.el)), a.isShown || (r.style.display = "none"), a.dom.el = r, a.isInDom && a.bindEvents())), r = a.dom.el) : ((a = new u.Target).init(null, e, n), a.hide()), a.isInDom ? (c = a.dom.el.nextElementSibling, o.push(h), l && (l.lastElementChild && l.appendChild(e.dom.document.createTextNode(" ")), e.insertDatasetFrag(l, a.dom.el, s), l = null)) : ((l = l || e.dom.document.createDocumentFragment()).lastElementChild && l.appendChild(e.dom.document.createTextNode(" ")), l.appendChild(a.dom.el), a.isInDom = !0, a.unbindEvents(), a.bindEvents(), a.hide(), t.toShow.push(a), s.push(a)), t.show.push(a)
      }
      for (l && ((c = c || e.config.layout.siblingAfter) && l.appendChild(e.dom.document.createTextNode(" ")), e.insertDatasetFrag(l, c, s)), p = 0; n = t.startDataset[p]; p++) h = n[e.config.data.uidKey], a = e.cache[h], t.show.indexOf(a) < 0 ? (t.hide.push(a), t.toHide.push(a), t.toRemove.push(a)) : i.push(h);
      f.isEqualArray(i, o) || (t.willSort = !0), e.callActions("afterDiffDatasets", arguments)
    },
    insertDatasetFrag: function (t, e, i) {
      var o = e ? f.arrayFromList(this.dom.parent.children).indexOf(e) : this.targets.length;
      for (this.dom.parent.insertBefore(t, e); i.length;) this.targets.splice(o, 0, i.shift()), o++
    },
    ...
    toggleOn: function () {
      ...
      return e.isToggling = !0, e.toggleArray.indexOf(o) < 0 && e.toggleArray.push(o), t = e.getToggleSelector(), e.multimix({
        filter: t
    ...
    toggleOff: function () {
      ...
      return e.isToggling = !0, -1 < s && e.toggleArray.splice(s, 1), t = e.getToggleSelector(), e.multimix({
        filter: t
      }, i.animate, i.callback)
    },
    sort: function () {
    ...
    dataset: function () {
      var t, e, i = this,
        ...
        s = null;
      return i.callActions("beforeDataset", arguments), i.isBusy ? ((s = new u.QueueItem).args = arguments, s.instruction = o, i.queueMix(s)) : (o.callback && (i.userCallback = o.callback), e = o.animate ^ i.config.animation.enable ? o.animate : i.config.animation.enable, t = i.getDataOperation(o.command.dataset), i.goMix(e, t))
    },
    multimix: function () {
      var t, e, i = this,
        o = null,
        s = i.parseMultimixArgs(arguments);
    ...
    getOperation: function (t) {
      var e = this,
        ...
        a = t.insert,
        r = new u.Operation;
      return (r = e.callFilters("operationUnmappedGetOperation", r, arguments)).id = f.randomHex(), r.command = t, r.startState = e.state, r.triggerElement = e.lastClicked, e.isBusy ? (e.config.debug.showWarnings && console.warn(u.messages.warningGetOperationInstanceBusy()), null) : (a && e.insertTargets(a, r), n && (r.toRemove = n.targets), r.startSort = r.newSort = r.startState.activeSort, r.startOrder = r.newOrder = e.targets, i && (r.startSort = r.startState.activeSort, r.newSort = i, r.willSort = e.willSort(i, r.startState.activeSort), r.willSort && e.sortOperation(r)), r.startFilter = r.startState.activeFilter, r.newFilter = o || f.extend(new u.CommandFilter, r.startFilter), "all" === r.newFilter.selector ? r.newFilter.selector = e.config.selectors.target : "none" === r.newFilter.selector && (r.newFilter.selector = ""), e.filterOperation(r), r.startContainerClassName = r.startState.activeContainerClassName, s ? (r.newContainerClassName = s.containerClassName, r.newContainerClassName !== r.startContainerClassName && (r.willChangeLayout = !0)) : r.newContainerClassName = r.startContainerClassName, e.config.animation.enable && (e.getStartMixData(r), e.setInter(r), r.docState = f.getDocumentState(e.dom.document), e.getInterMixData(r), e.setFinal(r), e.getFinalMixData(r), e.parseEffects(), r.hasEffect = e.hasEffect(), e.getTweenData(r)), r.willSort && (e.targets = r.newOrder), r.newState = e.buildState(r), e.callFilters("operationMappedGetOperation", r, arguments))
    },
    tween: function (t, e) {
      var i, o = null,
        s = null,
        n = -1;
      for (e = Math.min(e, 1), e = Math.max(e, 0), n = 0; o = t.show[n]; n++) s = t.showPosData[n], o.applyTween(s, e);
      for (n = 0; o = t.hide[n]; n++) o.isShown && o.hide(), -1 < (i = t.toHide.indexOf(o)) && (s = t.toHidePosData[i], o.isShown || o.show(), o.applyTween(s, e))
    },
    insert: function () {
    ...
    destroy: function (t) {
      ...
      for (s = 0; o = e.targets[s]; s++) t && o.show(), o.unbindEvents();
    ...
    render: function (t) {
      ...
      return (e = i(t)) && "object" == typeof e && f.isElement(e) ? o = e : "string" == typeof e && ((s = document.createElement("div")).innerHTML = e, o = s.firstElementChild), this.callFilters("elRender", o, arguments)
    },
    cacheDom: function (t) {
    ...
    applyTween: function (t, e) {
      var i, o, s = this,
        ...
        r = new u.StyleData,
        l = -1;
      for (s.callActions("beforeApplyTween", arguments), r.x = n.x, r.y = n.y, 0 === e ? s.hide() : s.isShown || s.show(), l = 0; i = u.features.TWEENABLE[l]; l++)
        ...
        if (!o) continue;
        r.y = n.y + o * e
      } else if (o instanceof u.TransformData) {
        if (!o.value) continue;
        r[i].value = n[i].value + o.value * e, r[i].unit = o.unit, a.push(i + "(" + r[i].value + o.unit + ")")
      } else {
        if (!o) continue;
        r[i] = n[i] + o * e, s.dom.el.style[i] = r[i]
      }(r.x || r.y) && a.unshift("translate(" + r.x + "px, " + r.y + "px)"), a.length && (s.dom.el.style[u.features.transformProp] = a.join(" ")), s.callActions("afterApplyTween", arguments)
    },
    ...
    applyStylesOut: function (t) {
      ...
      switch (e.operation = t.operation, e.callback = t.callback, e.isExcluded || e.mixer.targetsBound++, e.isBound = !0, e.applyTransition(i), s && 0 < t.posOut.width && 0 < t.posOut.height && (e.dom.el.style.width = t.posOut.width + "px", e.dom.el.style.height = t.posOut.height + "px", e.dom.el.style.marginRight = t.posOut.marginRight + "px", e.dom.el.style.marginBottom = t.posOut.marginBottom + "px"), e.mixer.config.animation.nudge || "hide" !== t.statusChange || o.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"), t.statusChange) {
        case "hide":
          n && (e.dom.el.style.opacity = e.mixer.effectsOut.opacity), o = o.concat(e.mixer.transformOut);
          break;
        case "show":
          n && (e.dom.el.style.opacity = 1)
      }(e.mixer.config.animation.nudge || !e.mixer.config.animation.nudge && "hide" !== t.statusChange) && o.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"), e.dom.el.style[u.features.transformProp] = o.join(" "), e.callActions("afterApplyStylesOut", arguments)
    },
    writeTransitionRule: function (t, e, i) {
      var o = this.getDelay(e),
        s = t + " " + (0 < i ? i : this.mixer.config.animation.duration) + "ms " + o + "ms " + ("opacity" === t ? "linear" : this.mixer.config.animation.easing);
      return this.callFilters("ruleWriteTransitionRule", s, arguments)
    },
    getDelay: function (t) {
      var e, i = this;
    ...
    handleTransitionEnd: function (t) {
      ...
      e.callActions("beforeHandleTransitionEnd", arguments), e.isBound && t.target.matches(e.mixer.config.selectors.target) && (-1 < i.indexOf("transform") || -1 < i.indexOf("opacity") || o && -1 < i.indexOf("height") || o && -1 < i.indexOf("width") || o && -1 < i.indexOf("margin")) && (e.callback.call(e, e.operation), e.isBound = !1, e.callback = null, e.operation = null), e.callActions("afterHandleTransitionEnd", arguments)
    },
    eventBus: function (t) {
...
function (z) {
  "use strict";
  var W = '<?xml version="1.0" encoding="utf-8"?><svg version="1.1"xmlns="http://www.w3.org/2000/svg"viewBox="0 12.705 512 486.59"x="0px" y="0px"xml:space="preserve"><polygon points="256.814,12.705 317.205,198.566 512.631,198.566 354.529,313.435 414.918,499.295 256.814,384.427 98.713,499.295 159.102,313.435 1,198.566 196.426,198.566 "/></svg>',
    o = {
      starWidth: "32px",
      normalFill: "gray",
      ratedFill: "#f39c12",
  ...
  function V(t, e, i) {
    var o = i / 100 * (e - t);
    return 1 === (o = Math.round(t + o).toString(16)).length && (o = "0" + o), o
  }
  ...
  function Y(n, u) {
    ...
    var f, o, m, g, v, t, e = z("<div/>").addClass("jq-ry-group-wrapper").appendTo(n),
      y = z("<div/>").addClass("jq-ry-normal-group").addClass("jq-ry-group").appendTo(e),
      s = z("<div/>").addClass("jq-ry-rated-group").addClass("jq-ry-group").appendTo(e),
      b = 0,
      a = u.rating,
      r = !1;
    ...
    function l(t) {
      ...
      var e = (a = t) / f,
        i = e * m;
      1 < e && (i += (Math.ceil(e) - 1) * v), w(u.ratedFill), (i = u.rtl ? 100 - i : i) < 0 ? i = 0 : 100 < i && (i = 100), s.css("width", i + "%")
    }

    function c() {
      t = o * u.numStars + g * (u.numStars - 1), m = o / t * 100, v = g / t * 100, n.width(t), l()
    }

    function d(t) {
      var e = u.starWidth = t;
      return o = window.parseFloat(u.starWidth.replace("px", "")), y.find("svg").attr({
        width: u.starWidth,
        height: e
      }), s.find("svg").attr({
        width: u.starWidth,
    ...
    function h(t) {
      return u.spacing = t, g = parseFloat(u.spacing.replace("px", "")), y.find("svg:not(:first-child)").css({
        "margin-left": t
      }), s.find("svg:not(:first-child)").css({
        "margin-left": t
      }), c(), n
    }

    function p(t) {
      return u.normalFill = t, (u.rtl ? s : y).find("svg").attr({
        fill: u.normalFill
      }), n
    }
    var _ = u.ratedFill;
    ...
    function w(t) {
      ...
      return u.multiColor ? (e = (a - b) / u.maxValue * 100, t = function (t, e, i) {
        ...
        var o = V(t.r, e.r, i),
          s = V(t.b, e.b, i);
        return "#" + o + V(t.g, e.g, i) + s
      }((i = u.multiColor || {}).startColor || U.startColor, i.endColor || U.endColor, e)) : _ = t, u.ratedFill = t, (u.rtl ? y : s).find("svg").attr({
        fill: u.ratedFill
      }), n
    }
    ...
    function S(t) {
      u.numStars = t, f = u.maxValue / u.numStars, y.empty(), s.empty();
      for (var e = 0; e < u.numStars; e++) y.append(z(u.starSvg || W)), s.append(z(u.starSvg || W));
      return d(u.starWidth), p(u.normalFill), h(u.spacing), l(), n
    }

    function k(t) {
      return u.maxValue = t, f = u.maxValue / u.numStars, u.rating > t && E(t), l(), n
    }

    function T(t) {
      return u.precision = t, E(u.rating), n
    }
    ...
    function I(t) {
      ...
      if (c < a) d = b;
        ...
        var h = (c - a) / (r - a);
        if (0 < g)
          for (var p = h *= 100; 0 < p;) m < p ? (d += f, p -= m + v) : (d += p / m * f, p = 0);
        else d = h * u.maxValue;
        i = (e = d) % f, o = f / 2, s = u.halfStar, ((n = u.fullStar) || s) && (n || s && o < i ? e += f - i : (e -= i, 0 < i && (e += o))), d = e
      }
      return u.rtl && (d = l - d), parseFloat(d)
    }
    ...
    this.rating = function (t) {
      return G(t) ? (E(t), n) : u.rating
    }, this.destroy = function () {
      var o, s;
      return u.readOnly || H(), Y.prototype.collection = (o = n.get(0), s = this.collection, z.each(s, function (t) {
        if (o === this.node) {
          var e = s.slice(0, t),
            i = s.slice(t + 1, s.length);
          return s = e.concat(i), !1
        }
      }), s), n.removeClass("jq-ry-container").children().remove(), n
      ...
      return G(e) ? i(e) : u[t]
    }, S(u.numStars), $(u.readOnly), u.rtl && x(u.rtl), this.collection.push(this), this.rating(u.rating, !0), r = !0, n.trigger("rateyo.init", {
      rating: u.rating
    })
  }
  ...
  Y.prototype.collection = [], window.RateYo = Y, z.fn.rateYo = function () {
    return function (i) {
      ...
      return i = z.extend({}, o, i), z.each(t, function () {
        var t = c(this, n);
        if (t) return t;
        var e = z(this),
          o = {},
        ...
        return z.each(e.data(), function (t, e) {
          var i;
          0 === t.indexOf("rateyo") && (i = (i = t.replace(/^rateyo/, ""))[0].toLowerCase() + i.slice(1), o[i] = e, delete s[i])
        }), new Y(z(this), z.extend({}, o, s))
      })
...
function (e) {
  ...
  function n(t, e, i) {
    ...
    for (s in "INPUT" !== n[0].nodeName && console && console.warn && console.warn("Base element should be <input>!", n[0]), (o = {
        skin: n.data("skin"),
        type: n.data("type"),
        min: n.data("min"),
        max: n.data("max"),
      ...
      }).values = o.values && o.values.split(","), o) o.hasOwnProperty(s) && (o[s] !== h && "" !== o[s] || delete o[s]);
  ...
  n.prototype = {
      ...
      drawLabels: function () {
        var t, e, i, o, s, n, a, r, l, c, d;
        this.options && (t = this.options.values.length, e = this.options.p_values, this.options.hide_from_to || ("single" === this.options.type ? (i = t ? this.decorate(e[this.result.from]) : (n = this._prettify(this.result.from), this.decorate(n, this.result.from)), this.$cache.single.html(i), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible") : (s = t ? (this.options.decorate_both ? (i = this.decorate(e[this.result.from]), i += this.options.values_separator, i += this.decorate(e[this.result.to])) : i = this.decorate(e[this.result.from] + this.options.values_separator + e[this.result.to]), o = this.decorate(e[this.result.from]), this.decorate(e[this.result.to])) : (n = this._prettify(this.result.from), a = this._prettify(this.result.to), this.options.decorate_both ? (i = this.decorate(n, this.result.from), i += this.options.values_separator, i += this.decorate(a, this.result.to)) : i = this.decorate(n + this.options.values_separator + a, this.result.to), o = this.decorate(n, this.result.from), this.decorate(a, this.result.to)), this.$cache.single.html(i), this.$cache.from.html(o), this.$cache.to.html(s), this.calcLabels(), r = Math.min(this.labels.p_single_left, this.labels.p_from_left), l = this.labels.p_single_left + this.labels.p_single_fake, c = this.labels.p_to_left + this.labels.p_to_fake, d = Math.max(l, c), this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", d = this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"), this.$cache.single[0].style.visibility = "hidden", c) : (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", Math.max(l, c))) : (this.$cache.from[0].style.visibility = "visible", this.$cache.to[0].style.visibility = "visible", this.$cache.single[0].style.visibility = "hidden"), r < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", d > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible")))
      },
      drawShadow: function () {
      ...
      convertToValue: function (t) {
        ...
        n && (r = e = n.length), a && (r = i = a.length), e && i && (r = i <= e ? e : i), o < 0 && (o = +(o + (l = Math.abs(o))).toFixed(r), s = +(s + l).toFixed(r));
        var c, d = (s - o) / 100 * t + o,
      ...
      appendGrid: function () {
        if (this.options.grid) {
          ...
          for (this.calcGridMargin(), a.grid_snap && (l = r / a.step), 50 < l && (l = 50), i = this.toFixed(100 / l), 4 < l && (d = 3), 7 < l && (d = 2), 14 < l && (d = 1), 28 < l && (d = 0), t = 0; t < l + 1; t++) {
            ...
            h += '<span class="irs-grid-pol" style="left: ' + c + '%"></span>', n = this.convertToValue(c), h += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + c + '%">' + (n = a.values.length ? a.p_values[n] : this._prettify(n)) + "</span>"
          }
      ...
      calcGridLabels: function () {
        for (var t, e = [], i = [], o = this.coords.big_num, s = 0; s < o; s++) this.coords.big_w[s] = this.$cache.grid_labels[s].outerWidth(!1), this.coords.big_p[s] = this.toFixed(this.coords.big_w[s] / this.coords.w_rs * 100), this.coords.big_x[s] = this.toFixed(this.coords.big_p[s] / 2), e[s] = this.toFixed(this.coords.big[s] - this.coords.big_x[s]), i[s] = this.toFixed(e[s] + this.coords.big_p[s]);
      ...
      calcGridCollision: function (t, e, i) {
        for (var o, s, n = this.coords.big_num, a = 0; a < n && !(n <= (o = a + t / 2)); a += t) s = this.$cache.grid_labels[o][0], i[a] <= e[o] ? s.style.visibility = "visible" : s.style.visibility = "hidden"
      },
